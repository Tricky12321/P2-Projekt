...
public class SynchronousSocketClient
{
    ...
    /*
    public static  SendPerson(Person person)
    {
        ...
        try
        {
            ...
            IPHostEntry ipHostInfo = Dns.GetHostByAddress("172.24.19.212");
    ...
    */
    ...
    public static string SendCommand(string command)
    {
        ...
        try
        {
            // Establish the remote endpoint for the socket.  
            // This example uses port 11000 on the local computer.  
            IPHostEntry ipHostInfo = Dns.GetHostByAddress("192.168.0.207");
            IPAddress ipAddress = ipHostInfo.AddressList[0];
            IPEndPoint remoteEP = new IPEndPoint(ipAddress, 11000);
    ...
    public static int Main(String[] args)
    {
        while (true)
        {
            ...
            p.Name = "Thue";
            p.Efternavn = "Iversen";
            //Console.WriteLine(SerializePerson(p));
            SendCommand(SerializePerson(p));
...
public class TooManyBytes : Exception
{
